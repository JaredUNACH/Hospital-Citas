...
import axios from 'axios'; // Importa axios para obtener las especialidades
...
const FormModal = ({ onClose, onSave }) => {
  const [formData, setFormData] = useState({
    ...
    rol: 'medico', // Valor predeterminado para el rol
    password: '', // Campo para la contraseña
    especialidad_id: '' // Campo para la especialidad
  });
      ...
      <div className="modal">
        <div className="modal-content">
          ...
          <form className="form" onSubmit={handleSubmit}>
            <p className="title">Registro de Médico</p>
            <div className="flex">
              <label>
            ...
            <div className="flex">
              ...
              <label>
                <select className="input" name="especialidad_id" value={formData.especialidad_id} onChange={handleChange} required>
